...
package com.io7m.lwjgl.examples.cuda;
...
/**
 * An example CUDA component.
 */

@Component(immediate = true)
public final class CudaComponent
{
  private static final Logger LOG =
    Logger.getLogger(CudaComponent.class.getCanonicalName());

  /**
   * Construct a component.
   */

  public CudaComponent()
  {
