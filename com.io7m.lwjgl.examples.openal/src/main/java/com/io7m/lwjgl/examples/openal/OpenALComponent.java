...
package com.io7m.lwjgl.examples.openal;
...
/**
 * An example OpenAL component.
 */

@Component(immediate = true)
public final class OpenALComponent
{
  private static final Logger LOG =
    Logger.getLogger(OpenALComponent.class.getCanonicalName());

  /**
   * Construct a component.
   */

  public OpenALComponent()
  {
